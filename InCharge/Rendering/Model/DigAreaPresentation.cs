...
{
    /// <summary>
    /// Represents a contiguous mining area
    /// </summary>
    public class DigAreaPresentation : IPresentation
    {               
        /// <summary>
        /// Mining area reference
        /// </summary>
        private DigArea area;
        /// <summary>
        ...
        public DigAreaPresentation(DigArea area, ContentManager content, GraphicsDevice graphicsDevice)
        {
            this.area = area;
            this.device = graphicsDevice;
            this.content = content;

            this.texture = content.Load<Texture2D>("Textures/Plan/dig_area");
        ...
        public SceneObject BuildSceneObject()
        {
            ...
            /* TODO: change to block position lookup
            foreach (TerrainBlock block in this.area.SelectedBlocks)
            {
                // create north face
            ...
            // ...
            var so = new SceneObject(md, "MiningSelection");
