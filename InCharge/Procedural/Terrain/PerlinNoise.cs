...
*/
    ...
    public class PerlinNoise
    {
        ...
        public PerlinNoise(int seed, int octaves, double amplitude, double frequency, double persistence)
        {
            _random = new Random(seed);
            this.seed = seed * 0.7201846209261;
        ...
        public double GetValue(double x, double y)
        {
            ...
            double vx0 = Lattice(ix, iy, fx0, fy0);
            double vx1 = Lattice(ix + 1, iy, fx1, fy0);

            double vy0 = Lerp(wx, vx0, vx1);

            vx0 = Lattice(ix, iy + 1, fx0, fy1);
            vx1 = Lattice(ix + 1, iy + 1, fx1, fy1);

            double vy1 = Lerp(wx, vx0, vx1);

            // really put the range to [0,1]
            var raw = Lerp(wy, vy0, vy1);
            var real = (raw + 1) * 0.5;
            return real;
        }
        ...
        {
            int index = Index(ix, iy);
            int g = index * 2;
            return _gradients[g] * fx + _gradients[g + 1] * fy;
        }
