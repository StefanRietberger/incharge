...
namespace Indiefreaks.Xna.Rendering.Camera
{
    ...
    /// </remarks>
    public abstract class CustomCamera3D : ICamera
    {
        ...
        protected CustomCamera3D(float aspectRatio, float fieldOfView, float nearPlaneDistance,
                         float farPlaneDistance)
        {
            ...
            SceneState = new SynapseGaming.LightingSystem.Core.SceneState();
            SceneEnvironment = new SynapseGaming.LightingSystem.Core.SceneEnvironment();
        }
        ...
        protected virtual Matrix UpdateProjectionMatrix()
        {            
            return Matrix.CreatePerspectiveFieldOfView(_fieldOfView, _aspectRatio, _nearPlaneDistance,
                                                                       _farPlaneDistance);
        }
        ...
        public virtual void BeginFrameRendering(GameTime gameTime, FrameBuffers frameBuffers)
        {
            this.SceneState.BeginFrameRendering(ViewMatrix, ProjectionMatrix, gameTime, SceneEnvironment, frameBuffers, true);
        }
